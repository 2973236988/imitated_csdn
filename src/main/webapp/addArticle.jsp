...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/articleListServlet/add" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="articleContent" name="articleContent" placeholder="请输入文章内容"/>
        </div>
